...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Sign in with your organizational account.");
        ...
        jLabel1.getAccessibleContext().setAccessibleName("Welcome To Login Page");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
            ...
            if(user.contains("Nadim") && (password.contains("nadim1155"))){
                jPasswordField1.setText(null);
                jTextField2.setText(null);

                Login_Sy Info = new Login_Sy();
